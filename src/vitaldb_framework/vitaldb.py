...
def load_cases(tnames, path_for_save, caseids=None, interval=1, maxcases=100):
    ...
    for caseid in caseids:
        try:
            ...
            print("Processing on: {}...".format(caseid))
            df = pd.DataFrame(case, columns=tnames)
            df.to_csv("{}/{}.csv".format(path_for_save, caseid),
                      header=True, index_label="Time")
            print("Finished on: {}...".format(caseid))
        except:
            pass
